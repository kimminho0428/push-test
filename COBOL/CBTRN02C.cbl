      ...
      *                                                                         
       ...
       01  FD-TRANFILE-REC.                                                     
           ...
           05 FD-TRAN-CAT-CD                    PIC 9(04).               
           05 FD-TRAN-SOURCE                    PIC X(10).               
           05 FD-TRAN-DESC                      PIC X(100).              
           05 FD-TRAN-AMT                       PIC S9(09)V99.           
           05 FD-TRAN-MERCHANT-ID               PIC 9(09).               
           05 FD-TRAN-MERCHANT-NAME             PIC X(50).               
           05 FD-TRAN-MERCHANT-CITY             PIC X(50).               
           05 FD-TRAN-MERCHANT-ZIP              PIC X(10).               
           05 FD-TRAN-CARD-NUM                  PIC X(16).               
           05 FD-TRAN-ORIG-TS                   PIC X(26).               
       ...
       01  FD-ACCTFILE-REC.                                                     
           ...
           05  FD-ACCT-CASH-CREDIT-LIMIT        PIC S9(10)V99.
           05  FD-ACCT-OPEN-DATE                PIC X(10).
           05  FD-ACCT-EXPIRAION-DATE           PIC X(10). 
           05  FD-ACCT-REISSUE-DATE             PIC X(10).
           05  FD-ACCT-CURR-CYC-CREDIT          PIC S9(10)V99.
           05  FD-ACCT-CURR-CYC-DEBIT           PIC S9(10)V99.
